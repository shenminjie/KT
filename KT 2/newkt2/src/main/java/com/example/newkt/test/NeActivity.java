...
String path = getIntent().getStringExtra("path");
        path = "/storage/emulated/0/幼儿园大课间.mp4";
        ...
        mVeoView.setOnPreparedListener(new NELivePlayer.OnPreparedListener() {
            ...
            public void onPrepared(final NELivePlayer neLivePlayer) {
                ...
                new MyCountDownTimer(neLivePlayer.getDuration(),1000, (TextView) findViewById(R.id.jindushow));
...
//                                    ((TextView) findViewById(R.id.jindushow)).setText();
